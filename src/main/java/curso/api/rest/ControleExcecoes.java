...
public class ControleExcecoes extends ResponseEntityExceptionHandler {
	...
	//PEGA ERROS MAIS COMUNS NO PROJETO
	@ExceptionHandler({ Exception.class, RuntimeException.class, Throwable.class }) // PEGANDO AS MSGS DE ERROS
	@Override
	protected ResponseEntity<Object> handleExceptionInternal(Exception ex, Object body, HttpHeaders headers,
		...
		// MONTANDO O OBJETO DE ERRO SERA EM JSON
		ObjetoErro objetoErro = new ObjetoErro();
		objetoErro.setError(msg);
		objetoErro.setCode(status.value() + "==>" + status.getReasonPhrase());

		// MONTANDO A MSG DE ERRO PARA ARGUMENTOS INVALIDOS
	...
	// ERROS QUE VEM DO BANCO DE DADOS COMO INSERT ETC
	...
	protected ResponseEntity<Object> handleExceptionDataIntegry(Exception ex) {
		...
		// MOSTRANDO A MSG DE ERROS MAIS VISIVEIS
